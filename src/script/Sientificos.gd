...
@export var es_cientifico : bool = true # Si es falso, actúa como policía
@export var radio_vision_base : float = 20.0
...
func _physics_process(delta):
	...
	if Global.dificultad == "easy":
		...
		radio_actual = 20.0  # Te ven desde muy lejos
...
func aplicar_danio_tiempo():
	...
	if Global.dificultad == "easy":
		...
		castigo = 35.0 if es_cientifico else 20.0
